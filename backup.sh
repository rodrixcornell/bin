...
# mv /opt/bkp/${origin}__workbench-mysql.rar ~/MEOCloud/bkp
...
# mv /opt/bkp/${origin}__lib.tgz ~/MEOCloud/bkp
...
# mv /opt/bkp/${origin}__Pastas.rar ~/MEOCloud/bkp
...
# mv /opt/bkp/${origin}__config.tgz ~/MEOCloud/bkp

echo "Backup Pasta Oracle"
#tar -czvf /opt/bkp/${origin}__etc.tgz /etc
rar a -m5 -idp -y /opt/bkp/${origin}__oracle.rar /opt/oracle
# mv /opt/bkp/${origin}__etc.rar ~/MEOCloud/bkp
...
#mv /opt/bkp/${origin}__bin.tgz ~/MEOCloud/bkp

...
while true; do
	...
	spawn sftp -prC deploy@carius; expect "password:"; send "deploy\r" ;expect "sftp>" ;send "put -r repos/\r"; send "bye\r"; interact'
	...
	spawn sftp -prC deploy@pericuma; expect "password:"; send "deploy\r" ;expect "sftp>" ;send "put -r repos/\r"; send "bye\r"; interact'
	...
	spawn sftp -prC deploy@parnamirim; expect "password:"; send "deploy\r" ;expect "sftp>" ;send "put -r repos/\r"; send "bye\r"; interact'
